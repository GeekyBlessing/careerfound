...
const variantClasses: Record<Variant, string> = {
  ...
  secondary: "bg-white/[0.06] text-ink-100 hover:bg-white/[0.1] border border-white/10",
  ghost: "bg-transparent text-ink-300 hover:text-ink-100 hover:bg-white/[0.05]",
